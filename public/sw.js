...
const CACHE = "takeoff-ops-v2";
const FILES = ["/", "/index.html", "/app.css", "/app.js", "/reader.js", "/manifest.webmanifest", "/icons/icon-192.png", "/icons/icon-512.png", "/icons/apple-touch-icon.png"];
